...
chain.name 				= 'Goerli test network';
chain.id 				= 5;
chain.rpcUrls 			= ['https://goerli.infura.io/v3/'];
chain.blockExplorerUrls = ['https://goerli.etherscan.io'];
var nativeCurrency 		= {}; 
nativeCurrency.name 	= 'ETH';
nativeCurrency.decimals = 5;
nativeCurrency.symbol 	= 'GoerliETH';
chain.nativeCurrency 	= nativeCurrency; 
